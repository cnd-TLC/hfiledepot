...
export default {
  ...
  methods: {
    ...
    getPpmpItem: function() {
      this.useToken();

      axios.get(apiEndPoint + "/api/ppmp_item/" + this.$route.query.id)
        .then((response) => {
          this.code = response.data.code
          this.general_desc = response.data.general_desc
          this.unit = response.data.unit
          this.quantity = response.data.quantity
          this.mode_of_procurement = response.data.mode_of_procurement
          this.est_budget = response.data.est_budget
          this.jan = response.data.jan
          this.feb = response.data.feb
          this.mar = response.data.mar
          this.apr = response.data.apr
          this.may = response.data.may
          this.jun = response.data.jun
          this.jul = response.data.jul
          this.aug = response.data.aug
          this.sept = response.data.sept
          this.oct = response.data.oct
          this.nov = response.data.nov
          this.dec = response.data.dec
        })
        .catch((error) => {
  ...
  setup() {
    ...
    const onSubmit = handleSubmit((values) => {
      ...
      axios.put(apiEndPoint + "/api/update_ppmp_item/" + route.query.id, values)
        .then((response) => {
          router.back();
