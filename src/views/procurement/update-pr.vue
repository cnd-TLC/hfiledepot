...
export default {
  ...
  methods: {
    ...
    getPr: function() {
      ...
      axios.get(apiEndPoint + "/api/purchase_request/" + this.$route.query.id)
        .then((response) => {
          this.pr_no = response.data["pr_no"];
          this.fund = response.data["fund"];
          this.fpp = response.data["fpp"];
  ...
  setup() {
    ...
    const onSubmit = handleSubmit((values) => {
      ...
      axios.put(apiEndPoint + "/api/update_purchase_request/" + route.query.id, values)
        .then((response) => {
